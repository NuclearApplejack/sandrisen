...
public class EParticle : MonoBehaviour {
    ...
    void Start()
    {
        ...
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/EParticle10", typeof(Sprite)) as Sprite;
        }
        else
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/EParticle15", typeof(Sprite)) as Sprite;
        }
