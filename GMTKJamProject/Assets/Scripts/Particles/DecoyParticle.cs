...
public class DecoyParticle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/DecoyParticle10", typeof(Sprite)) as Sprite;
        }
        else
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/DecoyParticle15", typeof(Sprite)) as Sprite;
        }
