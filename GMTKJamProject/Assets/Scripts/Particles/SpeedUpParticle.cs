...
public class SpeedUpParticle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/SpeedUpParticle10", typeof(Sprite)) as Sprite;
        }
        else
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/SpeedUpParticle15", typeof(Sprite)) as Sprite;
        }
