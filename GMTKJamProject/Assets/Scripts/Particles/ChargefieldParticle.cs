...
public class ChargefieldParticle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spawnDirection = (Random.Range(0, 4) * Mathf.PI / 2);
        ...
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/ChargefieldParticle10", typeof(Sprite)) as Sprite;
        }
        else
        {
            spriteRend.sprite = Resources.Load("Sprites/Environment/ChargefieldParticle15", typeof(Sprite)) as Sprite;
        }
